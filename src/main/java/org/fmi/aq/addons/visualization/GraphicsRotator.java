...
/**
 * This static utility class draws sub-images and text to graphics
 * with the chosen rotation angel.
 * @author Lasse Johansson
 */
public class GraphicsRotator {

    public static Graphics setRotatedText(Graphics g, int x, int y,
            double degrees, String text) {
    ...
    public static Graphics2D setRotatedImage(Graphics2D g2D, int x, int y,
            double degrees, BufferedImage img) {
    ...
    public static void setRotatedText(Graphics2D g2D, int x, int y,
            double degrees, String text) {
