...
/**
 * This is an extension to the ByteGeoGrid so that byte conversions can occur
 * to a 3D grid instead of 2D. The main use case is netCDF in which the 
 * value_scaler and offsets need to be applied to 3D data and not for a single
 * 2D layer at a time.
 * 
